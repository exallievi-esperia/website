  ...
  return (
    <Layout>
      ...
      <main className="mx-auto max-w-7xl p-6 lg:px-8 my-20">
            ...
            <div className="w-full md:w-1/2">
              <div className=" pb-12">
                <p className="dark:text-gray-200">
                  Per rendere concreto un patto tra generazioni puoi aiutare, attraverso un piccolo
                  gesto, l'associazione e la scuola donando il tuo 5x1000.
                ...
                <p className="dark:text-gray-200 mt-4">
                  Nella dichiarazione dei redditi firma l'apposito modulo e riporta il codice
                  fiscale dell'associazione Ex Allievi dell'Esperia{' '}
        ...
        {/* Erogazioni libere */}
        <div className="mt-20">
          <h2 className="font-bold text-3xl dark:text-white">Erogazioni libere</h2>
          ...
          <div className="flex flex-col sm:flex-row sm:gap-x-20 gap-y-10 sm:gap-y-0 items-center mt-5 justify-between">
            <div className=" text-gray-600 dark:text-gray-200">
              <p className="text-left sm:max-w-md md:max-w-3xl">
                Per effettuare una erogazione libera puoi utilizzare Paypal, clicca sul pulsante
                accanto. <br />
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-10 md:gap-y-0 leading-7 mt-5 text-gray-600 dark:text-gray-200">
            <p>
              Per quanto riguarda le erogazioni effettuate da enti e società, per esse è prevista la
              sola possibilità di deduzione dal reddito imponibile, nel medesimo limite del 10% del
              reddito complessivo dichiarato. Qualora la deduzione sia di ammontare superiore al
              reddito complessivo dichiarato, diminuito di tutte le deduzioni, l’eccedenza può
              essere computata negli anni successivi ma non oltre il quarto, fino a concorrenza del
              suo ammontare.
            </p>
            <p>
              Le erogazioni liberali effettuate a favore degli Enti del Terzo Settore sono
              detraibili o deducibili dalle imposte sui redditi, con modalità diverse a seconda del
              soggetto erogatore e dell’ente percipiente. La detraibilità interviene sull’imposta
              lorda. La deducibilità interviene invece sul reddito imponibile diminuendo la base
              imponibile fiscale.
            </p>
          </div>
