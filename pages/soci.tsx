      ...
      <main className="mx-auto max-w-7xl p-6 lg:px-8 my-20">
        ...
        <div className="flex flex-col md:flex-row md:justify-around gap-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            <h2 className="font-bold text-3xl md:text-center dark:text-white">Iscriviti</h2>
            <p className="mt-5 mb-2 leading-7 dark:text-gray-200">
              Se non sei socio dell’Associazione Ex Allievi dell’I.T.I.S. P. Paleocapa di Bergamo
              (Esperia) – APS ma vorresti diventarlo, segui queste semplici istruzioni:
            </p>
            ...
            <ol className="leading-7 mb-4 dark:text-gray-200">
              ...
              <li>
                <p>
                  2. Compila il modulo che apparirà ed invialo via email all’indirizzo
                  <a
              ...
              <li>
                <p>
                  3. Attendi la conferma (ti arriverà via email nel giro di qualche giorno) e versa
                  la quota annuale
                </p>
              </li>
            </ol>
            ...
            <p className="mb-8">
              Per i neo-diplomati la prima quota è <span className="underline">gratuita!</span>
            </p>
          ...
          <div className="w-full md:w-1/2 flex flex-col break-words">
            <h2 className="font-bold text-3xl md:text-center dark:text-white">Rinnova la quota</h2>
            <p className="mt-5 leading-7 mb-4 dark:text-gray-200">
              Se sei già socio dell’Associazione e vuoi rinnovare la tua quota annuale, pari a
              30,00€, premi sul pulsante
              <strong> RINNOVA</strong> per pagare con Carte di Credito/Debito o PayPal. <br />
              Puoi anche fare un bonifico bancario a: <br />
              IBAN <strong>IT84T0538711116000042430482</strong> (BPER Banca)
              <br />
              L’importo da versare è pari a €30,00 ma sei libero di donare quanto preferisci.
            </p>
            <p className="mb-8">
              L'anno sociale a cui fa riferimento la quota va dal 01/03 dell'anno corrente (
              {new Date().getFullYear()}) al 28/02 dell'anno successivo (
              {new Date().getFullYear() + 1}).
            </p>

            <Button
              text={'Rinnova'}
              link={'https://www.paypal.com/donate?hosted_button_id=23BL2KLNJ6MF8'}
              isBlank
              style="mt-auto w-full md:w-3/5 lg:w-1/3 text-center self-center"
              padding="px-8"
              uppercase
        ...
        <div className="mt-28">
          <h2 className="font-bold text-3xl dark:text-white">Perché diventare soci?</h2>
          <Slider
            {...settings}
