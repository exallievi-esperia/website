...
const riviste = [
  ...
  },
  {
    id: 16,
    year: 2024,
    link: 'https://drive.google.com/file/d/1Zzv5eLSgyA2U7bUhfqbRfjw5xXN1cQMI/view?usp=sharing',
    imgAlt: 'Anteprima rivista 2024',
    imgSrc: '/img/copertine/Copertina2024.jpeg',
  },
  {
    id: 17,
    year: 2025,
    link: 'https://drive.google.com/file/d/1mbeUN3534-dct9HlQmB7rhimi8f5I7Mq/view?usp=sharing',
...
const RivistaPage = () => {
  const [currentItems, setCurrentItems] = useState(16)
