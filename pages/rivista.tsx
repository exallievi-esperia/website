...
import Copertina2023 from '../public/img/copertine/Copertina2023.jpg'
  ...
  return (
    <Layout>
      ...
      <main className='mx-auto max-w-7xl p-6 lg:px-8 my-20'>
        ...
        <Link
            href='https://drive.google.com/file/d/1RL2X4MQM5oLfo5tuJkW3tPuKspnSnQw-/view?usp=sharing'
