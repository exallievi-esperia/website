    ...
    <Layout>
      ...
      <main className="mx-auto max-w-7xl p-6 lg:px-8 my-20">
        <div className="flex flex-col items-center md:px-32">
          ...
          <Link
            href="/"
            className="rounded-md bg-red-400 mt-10 px-3.5 py-2.5 text-sm font-semibold border border-red-400 text-white hover:bg-white hover:text-red-400 transition-colors duration-300"
          >
            Torna alla home
          </Link>
        </div>
