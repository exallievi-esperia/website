...
import { HiBars3, HiXMark, HiChevronDown, HiChatBubbleBottomCenterText } from 'react-icons/hi2'
import { HiMagnifyingGlass, HiDocumentText, HiBookOpen, HiCheckCircle } from 'react-icons/hi2'
            ...
            menuItem.href ? (
              <Link
                ...
                className={`text-sm font-semibold leading-6 transition text-gray-900 hover:text-gray-700 dark:text-gray-100 dark:hover:text-gray-200 ${
                  router.pathname === menuItem.href ? 'border-b-2 border-[#f25116]' : ''
                }`}
                key={menuItem.label}
              >
                {menuItem.label}
                      ...
                      {menuItem.subItems?.map(subItem => (
                        <div
                          ...
                          className={`group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50 dark:hover:bg-gray-700 ${
                            router.pathname === subItem.href ? 'bg-gray-50 dark:bg-gray-700' : ''
                          }`}
                        >
