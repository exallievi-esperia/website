...
import { MdFacebook, MdOutlineEmail, MdOutlinePhone, MdOutlineLocationOn } from 'react-icons/md'
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href="/" className="flex justify-center sm:justify-start">
              <Image src="/logo.svg" alt="Logo Ex Allievi Esperia" width={48} height={48} />
            </Link>

            <p className="mt-6 text-center leading-relaxed sm:text-left text-gray-700 dark:text-gray-200">
              Associazione Ex Allievi dell’ITIS P. Paleocapa di Bergamo, da più di cent'anni al
              fianco degli studenti.
            </p>

            <ul className="mt-8 flex flex-wrap justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  href="https://it.linkedin.com/company/exallievi-esperia"
                  rel="noreferrer"
                  target="_blank"
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Associazione</h3>
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Documenti</h3>
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Link utili</h3>
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Contatti</h3>
